...
imdbclasses = ('__background__', 'ma')

def test_features(dataset_name):
    gt_pkl = '../pkls/ma_{}_gt.pkl'.format(dataset_name)
...
def extract_gt_features(dataset_name):
    ...
    model_file = 'faster_rcnn_pytorch/models/saved_model_optha_partdouble/faster_rcnn_100000.h5'
    extractor = build_extractor(model_file, imdbclasses)
