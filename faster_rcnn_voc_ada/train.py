...
# hyper-parameters
# ------------
parser = argparse.ArgumentParser(description='train voc dataset')
...
output_dir = 'models/saved_vot2007'
...
trainval_dataset = VOCDataset('trainval', roidb, imdb.num_classes)
train_sampler = None
